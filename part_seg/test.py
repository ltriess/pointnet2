...
parser.add_argument(
    "--category",
    default="Airplane",
    help="Which single class to train on [default: Airplane]",
)
parser.add_argument(
    "--model",
    default="pointnet2_part_seg",
...
DATA_PATH = os.path.join(
    BASE_DIR, "data", "shapenetcore_partanno_segmentation_benchmark_v0_normal"
)
TEST_DATASET = part_dataset.PartDataset(
    root=DATA_PATH,
    npoints=NUM_POINT,
    classification=False,
    class_choice=FLAGS.category,
    split="test",
)
